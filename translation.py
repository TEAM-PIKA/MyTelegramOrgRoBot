class Translation(object):
    START_TEXT = """Hui!
please read the TnC before proceeding: https://t.me/Dark_cobra_support/81
...
by opening https://github.com/Thesanskariladka/MyTelegramOrgRoBot and clicking on the Pink Button
